...
abstract class AppLocalizations {
  ...
  /// No description provided for @textFieldHintServer.
  ///
  ...
  /// In en, this message translates to:
  /// **'Username'**
  String get textFieldHintUsername;

  /// No description provided for @textFieldHintPassword.
  ///
  /// In en, this message translates to:
  /// **'Password'**
  String get textFieldHintPassword;

  /// No description provided for @buttonTextConnect.
  ///
  /// In en, this message translates to:
  /// **'Connect'**
  String get buttonTextConnect;

  /// No description provided for @validatorTextFieldIsEmpty.
  ///
  /// In en, this message translates to:
  /// **'Field is empty'**
  String get validatorTextFieldIsEmpty;

  /// No description provided for @snackBarFTPConnectFailed.
  ///
  /// In en, this message translates to:
  /// **'Something got wrong'**
